#!/bin/bash
# Modal launcher for MaxRL training. Mirrors rloo_trainer/train_rloo_modal.sh.
...
save_dir="${SAVE_DIR:-/vol/checkpoints/maxrl_checkpoints}"

wandb_name="${WANDB_NAME:-maxrl_neb_lr${curr_lr}_bs${batch_size}_gs${group_size}_ent${entropy_coefficient}_kl${kl_divergence_coefficient}_thr${success_threshold}_temp${temperature}_topp${top_p}_topk${top_k}}"
